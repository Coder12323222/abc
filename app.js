...
async function apiFetch(url,options={},retry=true){
  ...
  if(r.status===401&&retry){
    const entered=prompt('Enter your Clipping HQ access key. This is NOT an AI provider API key.');
